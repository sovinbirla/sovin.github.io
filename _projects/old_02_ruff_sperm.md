...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/02_ruff_i.png" title="independent" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/02_ruff_s.png" title="sattelite" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/02_ruff_f.png" title="faeder" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
